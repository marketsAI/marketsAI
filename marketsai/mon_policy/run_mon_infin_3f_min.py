...
if RUN_ANALYSIS:
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "polown_prob_" + "_min_" + exp_names[0] + ".png")
    plt.show()
    plt.close()
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "polown_reset_" + "_min_" + exp_names[0] + ".png")
    plt.show()
    plt.close()
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "polmon_prob_" + "_min_" + exp_names[0] + ".png")
    plt.show()
    plt.close()
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "polmon_reset_" + "_min_" + exp_names[0] + ".png")
    plt.show()
    plt.close()
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "polreact_prob_" +"_min_"+ exp_names[0] + ".png")
    plt.show()
    plt.close()
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "polreact_reset_" + "_min_" + exp_names[0] + ".png")
    plt.show()
    plt.close()
    ...
    if OBS_IDSHOCK:
        ...
        plt.savefig(OUTPUT_PATH_FIGURES + "poldev_prob_" + +"_min_"+ exp_names[0] + ".png")
        plt.show()
        plt.close()
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "IRs_" + "_min_" + exp_names[0] + ".png")
    plt.show()
    plt.close()
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "cum_IRs_" +"_min_"+ exp_names[0] + ".png")
    plt.show()
    plt.close()
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "IRs_freq_" +"_min_"+ exp_names[0] + ".png")
    plt.show()
    plt.close()
    ...
    plt.savefig(OUTPUT_PATH_FIGURES + "IRs_size_"  +"_min_" + exp_names[0] + ".png")
    plt.show()
    plt.close()
