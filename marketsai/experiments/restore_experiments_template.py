...
""" This code provides a template for how to restore
an experiment after the initial run is finished.
Question: do we need to give him the cofig again? """
...
tune.run(
    ...
    restore="/Users/matiascovarrubias/ray_results/native_10hh_capital_planner_ma_run_August16_PPO/PPO_capital_planner_ma_acf75_00001_1_2021-08-17_19-56-01/checkpoint_000400/checkpoint-400",
    config={},
)
