function [IterRslt,IterFlag] = iter_capital_planner_4hh(GNDSGE_OPTIONS)
%% Add path
if ispc
...
z_agg_vals = [0.8, 1.2];
z_ind_vals = [0.9, 1.1];
[z_ind_1, z_ind_2, z_ind_3, z_ind_4, z_agg] = ndgrid(z_ind_vals, z_ind_vals, z_ind_vals, z_ind_vals, z_agg_vals);
z_agg = z_agg(:)';
z_ind_1 = z_ind_1(:)';
z_ind_2 = z_ind_2(:)';
z_ind_3 = z_ind_3(:)';
...
shock_trans = kron(kron(kron(kron(shock_trans_agg, shock_trans_ind),shock_trans_ind), shock_trans_ind),shock_trans_ind);
Kss  = (alpha * beta / (phi*delta*4*(1-beta*(1-delta))))^(1/(2-alpha));
KPts = 7;
KMin = Kss*0.5;
KMax = Kss*1.5;
...
assert(length(z_agg)==32);
assert(length(z_ind_1)==32);
assert(length(z_ind_2)==32);
assert(length(z_ind_3)==32);
assert(length(z_ind_4)==32);
assert(size(shock_trans,1)==32);
assert(size(shock_trans,2)==32);
...
[GNDSGE_TENSOR_shockIdx,GNDSGE_TENSOR_K_1,GNDSGE_TENSOR_K_2,GNDSGE_TENSOR_K_3,GNDSGE_TENSOR_K_4]=ndgrid(1:shock_num,K_1,K_2,K_3,K_4);
GNDSGE_TENSOR_z_agg=ndgrid(z_agg,K_1,K_2,K_3,K_4);
GNDSGE_TENSOR_z_ind_1=ndgrid(z_ind_1,K_1,K_2,K_3,K_4);
GNDSGE_TENSOR_z_ind_2=ndgrid(z_ind_2,K_1,K_2,K_3,K_4);
GNDSGE_TENSOR_z_ind_3=ndgrid(z_ind_3,K_1,K_2,K_3,K_4);
GNDSGE_TENSOR_z_ind_4=ndgrid(z_ind_4,K_1,K_2,K_3,K_4);
...
GNDSGE_LB = zeros(8,GNDSGE_NPROB);
GNDSGE_UB = 100*ones(8,GNDSGE_NPROB);
GNDSGE_LB(1:1,:)=0;
GNDSGE_UB(1:1,:)=1;
GNDSGE_LB(2:2,:)=0;
GNDSGE_UB(2:2,:)=1;
...
GNDSGE_UB(4:4,:)=1;
GNDSGE_LB(5:5,:)=0;
GNDSGE_UB(5:5,:)=((2/phi)*GNDSGE_TENSOR_z_agg(:)'.*GNDSGE_TENSOR_z_ind_1(:)'.*GNDSGE_TENSOR_K_1(:)'.^alpha).^(1/2)+(1-delta)*GNDSGE_TENSOR_K_1(:)';
GNDSGE_LB(6:6,:)=0;
GNDSGE_UB(6:6,:)=((2/phi)*GNDSGE_TENSOR_z_agg(:)'.*GNDSGE_TENSOR_z_ind_2(:)'.*GNDSGE_TENSOR_K_2(:)'.^alpha).^(1/2)+(1-delta)*GNDSGE_TENSOR_K_2(:)';
GNDSGE_LB(7:7,:)=0;
GNDSGE_UB(7:7,:)=((2/phi)*GNDSGE_TENSOR_z_agg(:)'.*GNDSGE_TENSOR_z_ind_3(:)'.*GNDSGE_TENSOR_K_3(:)'.^alpha).^(1/2)+(1-delta)*GNDSGE_TENSOR_K_3(:)';
GNDSGE_LB(8:8,:)=0;
GNDSGE_UB(8:8,:)=((2/phi)*GNDSGE_TENSOR_z_agg(:)'.*GNDSGE_TENSOR_z_ind_4(:)'.*GNDSGE_TENSOR_K_4(:)'.^alpha).^(1/2)+(1-delta)*GNDSGE_TENSOR_K_4(:)';


GNDSGE_EQVAL = 1e20*ones(8,GNDSGE_NPROB);
GNDSGE_F = 1e20*ones(1,GNDSGE_NPROB);
GNDSGE_SOL = zeros(8,GNDSGE_NPROB);
...
GNDSGE_DATA = zeros(1195,GNDSGE_NPROB);
...
GNDSGE_PP_s_1_interp=struct('form','pp','breaks',{{K_1,K_2,K_3,K_4}},'Values',reshape(s_1_interp,[],GNDSGE_SIZE_STATE{:}),'coefs',[],'order',GNDSGE_INTERP_ORDER,'Method',[],'ExtrapolationOrder',GNDSGE_EXTRAP_ORDER,'thread',NumThreads,'orient','curvefit');
GNDSGE_PP_s_1_interp=myinterp(myinterp(GNDSGE_PP_s_1_interp));

GNDSGE_PP_s_2_interp=struct('form','pp','breaks',{{K_1,K_2,K_3,K_4}},'Values',reshape(s_2_interp,[],GNDSGE_SIZE_STATE{:}),'coefs',[],'order',GNDSGE_INTERP_ORDER,'Method',[],'ExtrapolationOrder',GNDSGE_EXTRAP_ORDER,'thread',NumThreads,'orient','curvefit');
GNDSGE_PP_s_2_interp=myinterp(myinterp(GNDSGE_PP_s_2_interp));

GNDSGE_PP_s_3_interp=struct('form','pp','breaks',{{K_1,K_2,K_3,K_4}},'Values',reshape(s_3_interp,[],GNDSGE_SIZE_STATE{:}),'coefs',[],'order',GNDSGE_INTERP_ORDER,'Method',[],'ExtrapolationOrder',GNDSGE_EXTRAP_ORDER,'thread',NumThreads,'orient','curvefit');
GNDSGE_PP_s_3_interp=myinterp(myinterp(GNDSGE_PP_s_3_interp));

GNDSGE_PP_s_4_interp=struct('form','pp','breaks',{{K_1,K_2,K_3,K_4}},'Values',reshape(s_4_interp,[],GNDSGE_SIZE_STATE{:}),'coefs',[],'order',GNDSGE_INTERP_ORDER,'Method',[],'ExtrapolationOrder',GNDSGE_EXTRAP_ORDER,'thread',NumThreads,'orient','curvefit');
...
if ~GNDSGE_USE_OLD_VEC
    GNDSGE_SPLINE_VEC = convert_to_interp_eval_array({GNDSGE_PP_s_1_interp,GNDSGE_PP_s_2_interp,GNDSGE_PP_s_3_interp,GNDSGE_PP_s_4_interp});
end
...
if nargin>=1 && isfield(GNDSGE_OPTIONS,'WarmUp')
    if isfield(GNDSGE_OPTIONS.WarmUp,'var_interp')
        ...
        GNDSGE_TEMP = v2struct(K_1,K_2,K_3,K_4,GNDSGE_SIZE_STATE);
...
if ~GNDSGE_USE_OLD_VEC
    ...
    if REUSE_WARMUP_SOL==1 && isfield(GNDSGE_OPTIONS.WarmUp,'GNDSGE_PROB') && size(GNDSGE_OPTIONS.WarmUp.GNDSGE_PROB.GNDSGE_SOL,1)==size(GNDSGE_SOL,1)
        ...
        v2struct(GNDSGE_OPTIONS.WarmUp.var_state);
        GNDSGE_SOL_interp=struct('form','MKL','breaks',{{[1:shock_num],K_1,K_2,K_3,K_4}},'Values',reshape(GNDSGE_OPTIONS.WarmUp.GNDSGE_PROB.GNDSGE_SOL,[],GNDSGE_SIZE_STATE{:}),'coefs',[],'order',[2,2*ones(1,length(GNDSGE_SIZE_STATE))],'Method',[],'ExtrapolationOrder',[2,2*ones(1,length(GNDSGE_SIZE_STATE))],'thread',NumThreads,'orient','curvefit');
        GNDSGE_SOL_interp=myinterp(GNDSGE_SOL_interp);
        GNDSGE_LB_interp=struct('form','MKL','breaks',{{[1:shock_num],K_1,K_2,K_3,K_4}},'Values',reshape(GNDSGE_OPTIONS.WarmUp.GNDSGE_PROB.GNDSGE_LB,[],GNDSGE_SIZE_STATE{:}),'coefs',[],'order',[2,2*ones(1,length(GNDSGE_SIZE_STATE))],'Method',[],'ExtrapolationOrder',[2,2*ones(1,length(GNDSGE_SIZE_STATE))],'thread',NumThreads,'orient','curvefit');
        GNDSGE_LB_interp=myinterp(GNDSGE_LB_interp);
        GNDSGE_UB_interp=struct('form','MKL','breaks',{{[1:shock_num],K_1,K_2,K_3,K_4}},'Values',reshape(GNDSGE_OPTIONS.WarmUp.GNDSGE_PROB.GNDSGE_UB,[],GNDSGE_SIZE_STATE{:}),'coefs',[],'order',[2,2*ones(1,length(GNDSGE_SIZE_STATE))],'Method',[],'ExtrapolationOrder',[2,2*ones(1,length(GNDSGE_SIZE_STATE))],'thread',NumThreads,'orient','curvefit');
        GNDSGE_UB_interp=myinterp(GNDSGE_UB_interp);
        
        v2struct(GNDSGE_TEMP);
        GNDSGE_SOL = reshape(myinterp(GNDSGE_SOL_interp,[GNDSGE_TENSOR_shockIdx(:)';GNDSGE_TENSOR_K_1(:)';GNDSGE_TENSOR_K_2(:)';GNDSGE_TENSOR_K_3(:)';GNDSGE_TENSOR_K_4(:)'; ]),size(GNDSGE_SOL));
        GNDSGE_LB_NEW = reshape(myinterp(GNDSGE_LB_interp,[GNDSGE_TENSOR_shockIdx(:)';GNDSGE_TENSOR_K_1(:)';GNDSGE_TENSOR_K_2(:)';GNDSGE_TENSOR_K_3(:)';GNDSGE_TENSOR_K_4(:)'; ]),size(GNDSGE_LB));
        GNDSGE_UB_NEW = reshape(myinterp(GNDSGE_UB_interp,[GNDSGE_TENSOR_shockIdx(:)';GNDSGE_TENSOR_K_1(:)';GNDSGE_TENSOR_K_2(:)';GNDSGE_TENSOR_K_3(:)';GNDSGE_TENSOR_K_4(:)'; ]),size(GNDSGE_UB));
...
GNDSGE_DATA(:) = [repmat([shock_num;beta(:);sigma(:);alpha(:);delta(:);phi(:);shock_trans(:);z_agg(:);z_ind_1(:);z_ind_2(:);z_ind_3(:);z_ind_4(:); ],1,GNDSGE_NPROB);GNDSGE_TENSOR_shockIdx(:)';GNDSGE_TENSOR_K_1(:)';GNDSGE_TENSOR_K_2(:)';GNDSGE_TENSOR_K_3(:)';GNDSGE_TENSOR_K_4(:)';   ];
...
[GNDSGE_SOL,GNDSGE_F,GNDSGE_AUX,GNDSGE_EQVAL,GNDSGE_OPT_INFO] = mex_capital_planner_4hh(GNDSGE_SOL,GNDSGE_LB,GNDSGE_UB,GNDSGE_DATA,GNDSGE_SKIP,GNDSGE_F,GNDSGE_AUX,GNDSGE_EQVAL);
GNDSGE_USE_BROYDEN_NOW = 0;
...
s_3=GNDSGE_SOL(3:3,:);
s_4=GNDSGE_SOL(4:4,:);
K_1_next=GNDSGE_SOL(5:5,:);
K_2_next=GNDSGE_SOL(6:6,:);
K_3_next=GNDSGE_SOL(7:7,:);
K_4_next=GNDSGE_SOL(8:8,:);
...
outputVarStack = cat(1,reshape(s_1,1,[]),reshape(s_2,1,[]),reshape(s_3,1,[]),reshape(s_4,1,[]));
...
if shock_num>1
    ...
    output_interp=struct('form','MKL','breaks',{{1:shock_num,K_1,K_2,K_3,K_4}},...
        'Values',outputVarStack,...
        'coefs',[],'order',[2 OutputInterpOrder*ones(1,length({K_1,K_2,K_3,K_4}))],'Method',[],...
        'ExtrapolationOrder',[],'thread',NumThreads, ...
        'orient','curvefit');
else
    outputVarStack = reshape(outputVarStack, [],GNDSGE_SIZE_STATE{:});
    output_interp=struct('form','MKL','breaks',{{K_1,K_2,K_3,K_4}},...
        'Values',outputVarStack,...
        'coefs',[],'order',[OutputInterpOrder*ones(1,length({K_1,K_2,K_3,K_4}))],'Method',[],...
        'ExtrapolationOrder',[],'thread',NumThreads, ...
        'orient','curvefit');
end
...
IterRslt.output_var_index = output_var_index;
        ...
        IterRslt.var_shock = v2struct(z_agg,z_ind_1,z_ind_2,z_ind_3,z_ind_4);
        IterRslt.var_state = v2struct(K_1,K_2,K_3,K_4);
        IterRslt.var_policy = v2struct(s_1,s_2,s_3,s_4,K_1_next,K_2_next,K_3_next,K_4_next);
        IterRslt.var_interp = v2struct(s_1_interp,s_2_interp,s_3_interp,s_4_interp);
        IterRslt.var_aux = v2struct(GNDSGE_EMPTY);
        IterRslt.pp = v2struct(GNDSGE_PP_s_1_interp,GNDSGE_PP_s_2_interp,GNDSGE_PP_s_3_interp,GNDSGE_PP_s_4_interp,GNDSGE_SPLINE_VEC,GNDSGE_EMPTY);
        ...
        if ~NoSave
            if IterSaveAll
                save(['IterRslt_capital_planner_4hh_' num2str(GNDSGE_Iter) '.mat']);
            else
                save(['IterRslt_capital_planner_4hh_' num2str(GNDSGE_Iter) '.mat'],'IterRslt');
            end
        end
    end
end
