...
GNDSGE_SOL_ASG_INTERP = asg.construct_from_struct(IterRslt.sol_asg_interp_struct);
...
for GNDSGE_t=1:num_periods
    ...
    GNDSGE_SOL = GNDSGE_SOL_ASG_INTERP.eval_vec(SimuRslt.shock(:,GNDSGE_t)',[SimuRslt.b(:,GNDSGE_t)']);
