...
FOR_PUBLIC = False
SAVE_CSV = False
INPUT_PATH_EXPERS = "/Users/matiascovarrubias/Dropbox/RL_macro/Experiments/expINFO_native_multi_hh_cap_market_run_Aug25_PPO.json"
if FOR_PUBLIC:
...
# checkpoint_path = "/home/mc5851/ray_results/server_5hh_CapitalMarket_run_July21_PPO/PPO_CapitalMarket_46ca2_00006_6_2021-07-21_14-27-16/checkpoint_225/checkpoint-225"
...
if PLOT_PROGRESS == True:
    for i in range(len(exp_names)):
        ...
        max_rewards_i = data_progress_df[
            "evaluation/custom_metrics/discounted_rewards_mean"
        ].max()
        max_rewards.append(max_rewards_i)
